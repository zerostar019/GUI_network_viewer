...
"}")
    ...
    def retranslateUi(self, Authorization):
        ...
        self.label_3.setText(_translate("Authorization", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">Вам доступна информация уровня: </span></p><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">&quot;Совершенно секретно&quot;</span></p></body></html>"))
